...
class CustomGame(models.Model):
    ...
    player_1_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT,
                                    related_name='custom_game_as_player_1')
    player_2_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT,
                                    related_name='custom_game_as_player_2')
    player_1_score = models.PositiveSmallIntegerField(default=0)
    player_2_score = models.PositiveSmallIntegerField(default=0)
    winner_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, 
...
class Tournament(models.Model):
    ...
    player_3_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT,
                                    related_name='Tournament_as_player_3')
    player_4_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT,
