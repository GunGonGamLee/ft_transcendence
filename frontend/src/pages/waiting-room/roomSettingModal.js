export default function roomSettingModal(isVisible) {
  ...
  return `
       <div style="display: ${display}; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 860px; height: 500px; background: rgba(10, 10, 10, 0.95); border-radius: 25px; border: 5px #FBFF3E solid;">
          ...
          <div style="position: absolute; width: 753px; height: 62px; left: 64px; top: 300px;">
              ...
              <div style="position: absolute; width: 553px; height: 62px; left: 200px; border-radius: 10px; border: 3px white solid;"></div>
              <div style="position: absolute; left: 214px; top: 10px; text-align: center; color: white; font-size: 36px; font-family: Galmuri11, serif; font-weight: 400;">1234pass</div>
          </div>
          ...
          <div style="position: absolute; width: 751px; height: 62px; left: 66px; top: 126px;">
              ...
              <div style="position: absolute; width: 553px; height: 62px; left: 198px; border-radius: 10px; border: 3px white solid;"></div>
              <div style="position: absolute; left: 213px; top: 10px; text-align: center; color: white; font-size: 36px; font-family: Galmuri11, serif; font-weight: 400;">Zㅣ존 트센</div>
          </div>
